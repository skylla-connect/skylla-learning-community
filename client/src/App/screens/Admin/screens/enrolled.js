...
class ManageEnrolledTrainees extends React.Component {
    constructor(props) {
        super(props);
    ...
    deleteUserDetails(modId){
        this.db.collection("orders/8XAMQYBG1zOq6iCe7e2W9jajvSs2/items")
            .get()
            .then(querySnapshot => {
            try {
...
export default withStyles(useStyles)(ManageEnrolledTrainees);